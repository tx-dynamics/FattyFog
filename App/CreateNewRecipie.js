...
export default class CreateNewRecipie extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data:[],
    ...
    componentDidMount = async () => {
        ...
        let val= await ScreenOrientation.getOrientationAsync()
    ...
    render() {
        ...
        return (
            <>
                ...
                //  onLayout={data=>this.getNewDimensions(data)}
                >
                    {/* <View onLayout={data=>this.getNewDimensions(data)}
                    styles={{
                        height: this.state.pageHeight ,
                        width: this.state.pageWidth, 
                        backgroundColor:'red'
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            color: 'white', 
                            textAlign:'center',
                        }}>PLEASE SELECT FLAVOURS AND ENTER YOUR PERCENTAGE PER FLAVOUR </Text>
                    </View>
